...
class Training():
    def __init__(self):
        ...
        self.board_size = self.cfg["env"]["board_size"]
        self.num_envs = self.cfg["train_param"]["num_envs"]

        self.buffer_len = self.cfg["train_param"]["num_envs"]
        ...
        self.net2 = Q_nn()
        self.net2.eval()
        self.env_train = TinyGame.simplEnv(self.num_envs,self.board_size,self.buffer_len, render_mode=None)
